...
#define HPM_READ_PARTICLE_MEASURMENT_LEN_AMP 32
...
public:
     ...
     * @return  void
     */
    AMPHENOLSMUART04L(Stream& serial);
...
private:
    ...
    * @return  returns number of bytes read from sensor
    */
    int ReadCmdResp(byte dataBuf[]);
	unsigned int getCS(byte len, byte data[]);
};
#endif
